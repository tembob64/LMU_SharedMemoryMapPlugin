...
private:
  ...
  const unsigned long long mFuelAndEnergyOffset = 0x19FD318uLL; //0x1A1A6A0uLL; // mChangedParamValueOffset + 0xFE88
  const unsigned long long mFuelLastLapOffset = 0x1A03AC4uLL; //0x1A20DECuLL;   // mFuelAndEnergyOffset + 0x64FC

  const unsigned long long mChangedParamTypeOffset = 0x19ED3C8uLL;  // = mChangedParamValueOffset -0x10
  const unsigned long long mChangedParamValueOffset = 0x19ED3D8uLL; //0x1A0A880uLL;  //0x1A06890uLL; // offset 0x00 
  ...
  const unsigned long long mFront_ABR_Offset = 0x19F28C4uLL; //0x1A148F4uLL; //0x1A0FC4CuLL; //mChangedParamValueOffset + 0x5434
  const unsigned long long mRear_ABR_Offset = 0x19F2954uLL; //0x1A0FCDCuLL; // mFront_ABR_Offset + 0x90 
