...
#define PLUGIN_VERSION_MAJOR "4.0"
#define PLUGIN_VERSION_MINOR "16.0"

#ifdef VERSION_AVX2
#ifdef VERSION_MT
#define PLUGIN_NAME_AND_VERSION "LMU Shared Memory Map Plugin - v" PLUGIN_VERSION_MAJOR " AVX2+PGO+MT"
#else
#define PLUGIN_NAME_AND_VERSION "LMU Shared Memory Map Plugin - v" PLUGIN_VERSION_MAJOR " AVX2+PGO"
#endif
#else
#define PLUGIN_NAME_AND_VERSION "LMU Shared Memory Map Plugin - v" PLUGIN_VERSION_MAJOR
#endif
...
public:
  ...
  static bool mGameModeInitialized;
...
private:
  ...
  public:
    ExtendedStateTracker()
    {
      ...
      memset(&mExtended, 0, sizeof(LMU_Extended));
  ...
  private:
    ...
    DamageTracking mDamageTrackingInfos[LMU_Extended::MAX_MAPPED_IDS];
  };
...
private:
  ...
  bool mParticipantTelemetryUpdated[LMU_Extended::MAX_MAPPED_IDS];
  ...
  MappedBuffer<LMU_Extended> mExtended;
