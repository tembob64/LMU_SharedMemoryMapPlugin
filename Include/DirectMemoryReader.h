...
private:
  ...
  const unsigned long long mMotorMapOffset = 0x19F80E8uLL; //41DBEE8 offset +0x48
  const unsigned long long mChangedParamTypeOffset = 0x19F8090uLL; //0x19F75D0uLL; //0x19ED430uLL; //0x405FCB0uLL; offset -0x10
  const unsigned long long mChangedParamValueOffset = 0x19F80A0uLL; //0x19F75E0uLL; //0x19ED440uLL; //0x19ED440uLL; offset 0x00
  ...
  const unsigned long long mFront_ABR_Offset = 0x19FD4B4uLL; //0x19FC9F4uLL; //0x19F2854uLL;
  const unsigned long long mRear_ABR_Offset = 0x19FD544uLL; //0x19FCA84uLL; //0x19F28E4uLL;
